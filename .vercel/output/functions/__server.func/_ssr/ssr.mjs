...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CUPF-KTa.mjs");
...
var manifest = {
	"296b2ae78a6291faf32e443e7039b62560e8019d4b3ccb329f2d9429d36d5afd": {
		functionName: "triageIncident_createServerFn_handler",
		importer: () => import("./ops.functions-BBJ7EXSN.mjs")
	},
	"c6b4dd67b03e518a5fad3f58069fc9c62ff23f60df535dea7e97070e52c1958b": {
		functionName: "askGroqAssistant_createServerFn_handler",
		importer: () => import("./ops.functions-BBJ7EXSN.mjs")
	},
	"c98c4b820457d24665b6a9a7bd7c0bde0d88867ed5af3aac228a136161958c45": {
		functionName: "calculateRoute_createServerFn_handler",
		importer: () => import("./ops.functions-BBJ7EXSN.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CsYF_FW3.mjs"),
		import("./start-DV389_k7.mjs"),
...
//#endregion
export { getServerFnById as a, createStart as i, createMiddleware as n, ssr_exports as o, createServerFn as r, TSS_SERVER_FUNCTION as t };
