...
var v$1 = Symbol.asyncIterator, dr = Symbol.hasInstance, R = Symbol.isConcatSpreadable, C = Symbol.iterator, gr = Symbol.match, yr = Symbol.matchAll, Nr = Symbol.replace, br = Symbol.search, vr = Symbol.species, Cr = Symbol.split, Ar = Symbol.toPrimitive, P$1 = Symbol.toStringTag, Er = Symbol.unscopables;
var nt = {
...
var H$1 = B$1(2), J = B$1(3), Ee = B$1(1), Ie = B$1(0), ut = B$1(4), lt = B$1(5), ct = B$1(6), ft = B$1(7);
function dn(e) {
	switch (e) {
		case "\"": return "\\\"";
		case "\\": return "\\\\";
...
var L = "__SEROVAL_REFS__", le$1 = "$R", Re = `self.${le$1}`;
function yn(e) {
	return e == null ? `${Re}=${Re}||[]` : `(${Re}=${Re}||{})["${y$1(e)}"]=[]`;
}
var Ir = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map();
function Rr(e) {
	return Ir.has(e);
}
function bn(e) {
