    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Monitor waste management and carbon impact.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <KpiCard
          ...
          label="Energy Saved"
          value="1.2 MWh"
          sub="Smart lighting optimization"
          tone="brand"
        />
      </div>
          ...
          {[
            ...
            <div key={bin.id} className="flex flex-col gap-2 rounded-2xl border border-border p-3">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`text-xs font-bold ${bin.fill > 80 ? "text-danger" : "text-success"}`}
                >
                  {bin.fill}% Full
                </div>
              </div>
              <div className="h-1.5 w-full rounded-full bg-secondary overflow-hidden">
                <div
                  className={`h-full ${bin.fill > 80 ? "bg-danger" : "bg-success"}`}
