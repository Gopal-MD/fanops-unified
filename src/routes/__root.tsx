  ...
  head: () => ({
    meta: [
      ...
      { title: "MatchDay Command — Stadium Operations & Fan Experience" },
      {
        name: "description",
        content:
          "Unified stadium ops dashboard and fan PWA for MatchDay operations: routing, crowd density, incident triage, and real-time broadcasts.",
      },
      { property: "og:title", content: "MatchDay Command" },
      {
